      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 mb-12 shadow-2xl">
          ...
          <div className="mt-6 pt-6 border-t border-slate-700/50 text-center">
            ...
            <div className="text-slate-500 text-xs mt-2">
              The mathematical constant that makes universal conversion possible
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 hover:border-blue-500/50 transition-all">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              1,500+ tests · 98.7% coverage · Dershowitz & Reingold algorithms ·
              Hub-and-spoke architecture via JDN
            </p>
          </div>
          ...
          <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 hover:border-purple-500/50 transition-all">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              TypeScript · ESM · Tree-shakeable · 5kb-50kb bundle sizes · Plugin
              architecture · Extensively tested, actively maintained
            </p>
          </div>

          <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 hover:border-pink-500/50 transition-all">
            <div className="text-4xl mb-4">🧩</div>
            <h3 className="text-xl font-bold text-white mb-2">
              Modular & Flexible
            </h3>
            <p className="text-slate-300 text-sm leading-relaxed">
              12 calendar systems · 4 package tiers · Choose your bundle · Add
              custom plugins · Universal interop
            </p>
          </div>
        </div>

        {/* Beta Disclaimer */}
        <div className="bg-blue-900/10 border border-blue-700/30 rounded-xl p-4 mb-12 text-center">
        ...
        <div className="bg-gradient-to-r from-blue-900/20 via-purple-900/20 to-pink-900/20 border border-purple-500/30 rounded-2xl p-8 mb-12">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-300 leading-relaxed mb-6">
              Humans have created dozens of calendar systems across cultures and
              millennia. Each arose from different astronomical observations,
              cultural needs, and religious traditions.
            </p>
            <p className="text-lg text-slate-300 leading-relaxed mb-6">
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="bg-slate-900/30 border border-slate-700/50 rounded-xl p-4">
            ...
            <div className="text-slate-400 text-sm mt-1">Calendar Systems</div>
          </div>
          <div className="bg-slate-900/30 border border-slate-700/50 rounded-xl p-4">
