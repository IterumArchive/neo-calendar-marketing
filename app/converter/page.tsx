                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {!result.error && result.jdn && (
                            <div className="text-right">
                              <div className="text-xs text-slate-500">JDN</div>
            ...
            <div className="mt-6 bg-gradient-to-r from-cyan-900/20 to-blue-900/20 border border-cyan-700/50 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-sm text-slate-300">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">✓</span>
                  <span>
                    <span className="font-semibold">Algorithmic precision</span>{" "}
                    - Published formulas verified against authoritative sources
                  </span>
                </li>
              </ul>
              ...
              <div className="mt-4 pt-4 border-t border-cyan-700/30">
                ...
                <p className="text-xs text-slate-300 mb-2">
                  All calendars use <strong className="text-purple-300">proleptic extension</strong> — mathematical projection beyond their historical usage periods. For example, the Gregorian calendar (adopted 1582) extends infinitely backward using the same leap year rules.
                </p>
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="bg-slate-950/50 rounded p-2">
                    <p className="font-semibold text-blue-300 mb-1">Internal (Astronomical)</p>
                    <p className="text-slate-400">Includes year 0 for continuous math</p>
                    <p className="font-mono text-slate-500 mt-1">-2, -1, 0, 1, 2</p>
                  </div>
                  <div className="bg-slate-950/50 rounded p-2">
                    <p className="font-semibold text-emerald-300 mb-1">Display (Historical)</p>
                    <p className="text-slate-400">Shows familiar BCE/CE notation</p>
                    <p className="font-mono text-slate-500 mt-1">2 BCE, 1 BCE, 1 CE</p>
                  </div>
                </div>
                <p className="text-xs text-slate-400 mt-2">
                  This prevents off-by-one errors in deep time calculations while preserving familiar historical notation.
                </p>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-cyan-700/30">
                <p className="text-xs text-slate-400">
                  ...
                  NeoCalendar is in active development. We recommend additional
                  validation before use in mission-critical production systems.
                </p>
              </div>
            </div>
          </div>
