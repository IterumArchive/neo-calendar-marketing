        ...
        <div className="max-w-7xl mx-auto px-8 py-16">
          ...
          <div className="mb-8 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-blue-700/50 rounded-2xl p-8">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              The Julian Day Number (JDN) is a continuous count of days since
              noon Universal Time on January 1, 4713 BCE (in the proleptic
              Julian calendar). It provides a universal reference point for all
              calendar systems.
            </p>
